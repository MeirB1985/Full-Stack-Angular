...
export function productEditedAction(product: ProductModel): ProductAction {
    return { type: ProductActionType.productEdited, payload: product };
}
...
export function productsReducer(currentState: ProductsState = new ProductsState(), action: ProductAction): ProductsState {
    ...
    switch(action.type) {
        ...
        case ProductActionType.productAdded: // Here payload is the added product (ProductModel)
            ...
            break;
        case ProductActionType.productEdited: { // Here payload is the updated product (ProductModel)
