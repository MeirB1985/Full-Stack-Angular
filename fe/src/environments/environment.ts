...
export const environment = {
    ...
    adminUrl: "http://localhost:3030/api/admin/",
    productsUrl: "http://localhost:3030/api/products/",
    cartsUrl: "http://localhost:3030/api/carts/",
    itemUrl: "http://localhost:3030/api/items/",
    itemsUrlDelayed: "http://localhost:3030/api/products/delayed/",
    itemImagesUrl: "http://localhost:3030/api/products/images/",
